...
class MultiPoint(BaseMultiPoint):
    ...
    @classmethod
    def from_wkb(cls, value: bytes, srs_id: int) -> MultiPoint: ...
...
class MultiPointZ(BaseMultiPoint):
    ...
    @classmethod
    def from_wkb(cls, value: bytes, srs_id: int) -> MultiPointZ: ...
...
class MultiPointM(BaseMultiPoint):
    ...
    @classmethod
    def from_wkb(cls, value: bytes, srs_id: int) -> MultiPointM: ...
...
class MultiPointZM(BaseMultiPoint):
    ...
    @classmethod
    def from_wkb(cls, value: bytes, srs_id: int) -> MultiPointZM: ...
